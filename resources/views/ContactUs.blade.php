...
<head>
    ...
    <title>Send Us Your Questions/Comments</title>
...
<div id="wrapper">
    ...
    <div id="main"><!-- InstanceBeginEditable name="bCrumbs" -->
        ...
        <p>Feel free to submit this form with any quesitons or comments you may   have.</p>
        ...
        <input name="fname" required="" id="Fname" size="25" maxlength="30" type="text">
        <label for="lname"><span class="colorChange">*</span>LAST NAME:</label>
        <input name="lname" required="" id="Lname" size="25" maxlength="30" type="text">
        ...
        <input name="TelNum" id="TelNum" placeholder="XXX-XXX-XXXX" size="25" maxlength="35" type="tel">
        <label for="comments"><span class="colorChange">*</span>QUESTIONS/COMMENTS</label><textarea name="comments" cols="40" rows="10" required="" id="messages"></textarea>
        <input name="required" value="fname, lname, email, messages" type="hidden">
